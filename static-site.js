    ...
    <section class="contact-section reveal" id="contact"${sbObject("contact")}>
      <div class="contact-card">
        ...
        <div class="contact-links">
          ...
          <a href="https://wa.me/${escapeHtml(String(site.whatsapp || "YOUR_WHATSAPP_NUMBER").replace(/\D/g, ""))}" target="_blank" rel="noopener">WhatsApp Consultation</a>
          <a href="${escapeHtml(site.domain)}">${escapeHtml(hostFromUrl(site.domain))}</a>
        </div>
      </div>
      <form class="contact-form" name="website-inquiry" data-static-form="true" data-contact-form>
...
function renderSite(content) {
  ...
  window.AIMAZE_WHATSAPP_NUMBER = content.site?.whatsapp || "YOUR_WHATSAPP_NUMBER";
  const page = currentPage();
